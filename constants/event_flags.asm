...
; Other flags remain set until cleared
	const EVENT_GOT_TM31_MUD_SLAP ; 008
	...
	const EVENT_MADE_WHITNEY_CRY ; 028
	...
	const EVENT_LAKE_OF_RAGE_EXPLAINED_WEIRD_MAGIKARP ; 038
	const EVENT_LAKE_OF_RAGE_ASKED_FOR_MAGIKARP
	const EVENT_LAKE_OF_RAGE_ELIXIR_ON_STANDBY
	const EVENT_TRIGGERED_CELEBI_EVENT
	const EVENT_CELEBI_REMATCH_READY
	...
	const EVENT_GOT_PINK_BOW_FROM_MARY ; 048
	...
	const EVENT_UNOWN_HATCHED
	const EVENT_SHOWED_UNOWN_TO_ELM
	const EVENT_GOT_EVERSTONE_FROM_ELM
	const EVENT_GOT_QUICK_CLAW
	const EVENT_GOT_TM10_HIDDEN_POWER ; 058
	...
	const EVENT_GOT_HITMONTOP_FROM_KIYO
	...
	const EVENT_MET_SUNNY_OF_SUNDAY ; 068
	...
	const EVENT_TOLD_ELM_ABOUT_UNOWN_OVER_THE_PHONE
	const EVENT_GOT_CLEAR_BELL ; 078
	...
	const EVENT_ILEX_FOREST_HIDDEN_ETHER ; 088
	...
	const EVENT_WHIRL_ISLAND_B1F_HIDDEN_ULTRA_BALL ; 098
	...
	const EVENT_ROUTE_34_HIDDEN_SUPER_POTION ; 0a8
	...
	const EVENT_SILVER_CAVE_OUTSIDE_HIDDEN_FULL_RESTORE ; 0b8
	...
	const EVENT_LEGITIMATE_VIRTUAL_BOY
	...
	const EVENT_CLEARED_NUGGET_BRIDGE ; 0d8
	...
	const EVENT_ROCK_TUNNEL_1F_HIDDEN_X_DEFEND ; 0e8
	...
	const EVENT_VIRIDIAN_FOREST_HIDDEN_REVIVE ; 0f0
	...
	const EVENT_ROUTE_25_HIDDEN_POTION ; 0f8
	...
	const EVENT_CERULEAN_CAVE_1F_RARE_CANDY
	const EVENT_CERULEAN_CAVE_1F_MAX_ELIXIR
	const EVENT_CERULEAN_CAVE_1F_MAX_REVIVE
	const EVENT_CERULEAN_CAVE_1F_ULTRA_BALL ; 108
	const EVENT_CERULEAN_CAVE_1F_HIDDEN_PP_UP
	const EVENT_CERULEAN_CAVE_2F_RARE_CANDY
	const EVENT_CERULEAN_CAVE_2F_LIGHT_BALL
	const EVENT_CERULEAN_CAVE_2F_MAX_REVIVE
	const EVENT_CERULEAN_CAVE_2F_FULL_RESTORE
	const EVENT_CERULEAN_CAVE_2F_HIDDEN_PP_UP
	const EVENT_CERULEAN_CAVE_B1F_MEWTWO
	const EVENT_CERULEAN_CAVE_B1F_BERSERK_GENE ; 110
	const EVENT_CERULEAN_CAVE_B1F_KINGS_ROCK
	...
	const EVENT_SEAFOAM_ISLANDS_B1F_HIDDEN_ICE_HEAL ; 118
	...
	const EVENT_SEAFOAM_ISLANDS_B4F_ARTICUNO ; 120
	const EVENT_SEAFOAM_ISLANDS_B4F_NEVERMELTICE
	const EVENT_SEAFOAM_ISLANDS_B4F_ULTRA_BALL
	const EVENT_POKEMON_TOWER_2F_ESCAPE_ROPE
	const EVENT_POKEMON_TOWER_2F_EVAN
	const EVENT_POKEMON_TOWER_3F_NIGHTMARE
	const EVENT_POKEMON_TOWER_5F_MAX_REVIVE
	const EVENT_POKEMON_TOWER_6F_TWISTEDSPOON
	const EVENT_POKEMON_TOWER_6F_THICK_CLUB ; 128
	const EVENT_POWER_PLANT_B1F_ZAPDOS
	const EVENT_KYOGRE_IN_MOUNT_MORTAR
	const EVENT_POWER_PLANT_B1F_ZAP_CANNON
	const EVENT_POWER_PLANT_B1F_METAL_POWDER
	const EVENT_POWER_PLANT_B1F_SCOPE_LENS
	const EVENT_POWER_PLANT_B1F_THUNDERSTONE
	const EVENT_POWER_PLANT_B1F_FULL_RESTORE
	const EVENT_POWER_PLANT_B1F_ELECTRODE_1 ; 130
	const EVENT_POWER_PLANT_B1F_ELECTRODE_2
	const EVENT_POWER_PLANT_B1F_ELECTRODE_3
	const EVENT_POWER_PLANT_B1F_ELECTRODE_4
	const EVENT_POWER_PLANT_B1F_ELECTRODE_5
	const EVENT_POWER_PLANT_B1F_ELECTRODE_6
	const EVENT_POWER_PLANT_B1F_ELECTRODE_7
	const EVENT_POWER_PLANT_B1F_ELECTRODE_8
	const EVENT_POWER_PLANT_B1F_ELECTRODE_9 ; 138
	const EVENT_GROUDON_IN_POKEMON_MANSION
	const EVENT_POKEMON_MANSION_B1F_BLIZZARD
	const EVENT_POKEMON_MANSION_B1F_AWAKENING
	const EVENT_POKEMON_MANSION_B1F_HEAVY_BALL
	const EVENT_BEAT_SCIENTIST_TAYLOR
	const EVENT_BEAT_SCIENTIST_GIDEON
	const EVENT_BEAT_BURGLAR_SIMON
	const EVENT_POKEMON_MANSION_3F_ESCAPE_ROPE ; 140
	const EVENT_POKEMON_MANSION_3F_NUGGET
	const EVENT_POKEMON_MANSION_3F_FIRE_BLAST
	const EVENT_BEAT_COOLTRAINERM_YUJI
	const EVENT_BEAT_BURGLAR_JAC
	const EVENT_POKEMON_MANSION_2F_RARE_CANDY
	const EVENT_POKEMON_MANSION_2F_BRIGHTPOWDER
	const EVENT_POKEMON_MANSION_2F_LEMONADE
	const EVENT_POKEMON_MANSION_2F_POKE_DOLL ; 148
	const EVENT_BEAT_SCIENTIST_BRAYDON
	const EVENT_BEAT_BURGLAR_DUSTY
	const EVENT_POKEMON_MANSION_1F_ELIXIR
	const EVENT_POKEMON_MANSION_1F_PINK_BOW
	const EVENT_POKEMON_MANSION_1F_FIRE_STONE
	const EVENT_MOLTRES_IN_VICTORY_ROAD
	const EVENT_BEAT_RIVAL_IN_INDIGO
	const EVENT_TM_BLACK_MARKET_BATTLE_TENT ; 150
	const EVENT_LARRY_IN_ROCKET_HIDEOUT
	const EVENT_ONIXTRET_IN_ROCKET_HIDEOUT
	const EVENT_CHIQUIRTLE_IN_ROCKET_HIDEOUT
	const EVENT_HOOTDUO_IN_ROCKET_HIDEOUT
	const EVENT_TOGEKEY_IN_ROCKET_HIDEOUT
	const EVENT_HOPPORITA_IN_ROCKET_HIDEOUT
	const EVENT_WOOCHUM_IN_ROCKET_HIDEOUT
	const EVENT_ROCKET_HIDEOUT_B2F_RARE_CANDY ; 158
	const EVENT_ROCKET_HIDEOUT_B4F_REVIVAL_HERB
	const EVENT_ROCKET_HIDEOUT_B4F_LEVEL_BALL
	const EVENT_ROCKET_HIDEOUT_B4F_BLACKGLASSES
	const EVENT_BEAT_ROCKET_GRUNTM_32
	const EVENT_ROCKET_HIDEOUT_B1F_SODA_POP
	const EVENT_ROCKET_HIDEOUT_B3F_NORMAL_BOX_1
	const EVENT_ROCKET_HIDEOUT_B3F_NORMAL_BOX_2
	const EVENT_ROCKET_HIDEOUT_B3F_NORMAL_BOX_3 ; 160
	const EVENT_ROCKET_HIDEOUT_B3F_NORMAL_BOX_4
	const EVENT_ROCKET_HIDEOUT_B3F_NORMAL_BOX_5
	const EVENT_ROCKET_HIDEOUT_B3F_NORMAL_BOX_6
	const EVENT_ROCKET_HIDEOUT_B3F_GS_BALL
	const EVENT_BEAT_GMMTMT
	...
	const EVENT_TRICK_HOUSE_FINISHED_PUZZLE_2
	const EVENT_TRICK_HOUSE_FINISHED_PUZZLE_3
	const EVENT_TRICK_HOUSE_FINISHED_PUZZLE_4 ; 170
	const EVENT_TRICK_HOUSE_FINISHED_PUZZLE_5
	const EVENT_TRICK_HOUSE_FINISHED_PUZZLE_6
	const EVENT_TRICK_HOUSE_SCROLL_ACTIVE
	const EVENT_TRICK_HOUSE_FOUND_PUZZLE_SCROLL
	const EVENT_TRICK_HOUSE_DOOR_OPEN
	const EVENT_TRICK_HOUSE_GOT_FLOWER_MAIL
	const EVENT_TRICK_HOUSE_GOT_SURF_MAIL
	const EVENT_TRICK_HOUSE_GOT_LITEBLUEMAIL ; 178
	const EVENT_TRICK_HOUSE_GOT_PORTRAITMAIL
	const EVENT_TRICK_HOUSE_GOT_LOVELY_MAIL
	const EVENT_TRICK_HOUSE_GOT_EON_MAIL
	const EVENT_TRICK_HOUSE_GOT_MORPH_MAIL
	...
	const EVENT_TRICK_HOUSE_BEAT_CATHY ; 188
	...
	const EVENT_TRICK_HOUSE_BEAT_VINCE ; 190
	const EVENT_TRICK_HOUSE_BEAT_JULES
	const EVENT_SAFARI_ZONE_CENTER_LUCKY_PUNCH
	const EVENT_SAFARI_ZONE_CENTER_MAX_POTION
	const EVENT_SAFARI_ZONE_EAST_LEAF_STONE
	const EVENT_SAFARI_ZONE_EAST_STICK
	...
	const EVENT_BEAT_MT_BATTLE_3
	const EVENT_BEAT_MT_BATTLE_4
	const EVENT_BEAT_MT_BATTLE_5
	const EVENT_BEAT_MT_BATTLE_6
	const EVENT_BEAT_MT_BATTLE_7
	const EVENT_BEAT_MT_BATTLE_8
	const EVENT_BEAT_MT_BATTLE_9 ; 1e8
	const EVENT_BEAT_MT_BATTLE_10
	const EVENT_BEAT_MT_BATTLE_11
	const EVENT_BEAT_MT_BATTLE_12
	const EVENT_BEAT_MT_BATTLE_13
	const EVENT_BEAT_MT_BATTLE_14
	const EVENT_BEAT_MT_BATTLE_15
	const EVENT_BEAT_MT_BATTLE_16
	const EVENT_BEAT_MT_BATTLE_17 ; 1f0
	const EVENT_BEAT_MT_BATTLE_18
	const EVENT_BEAT_MT_BATTLE_19
	const EVENT_BEAT_MT_BATTLE_20
	const EVENT_BEAT_MT_BATTLE_21
	const EVENT_BEAT_MT_BATTLE_22
	const EVENT_BEAT_MT_BATTLE_23
	const EVENT_BEAT_MT_BATTLE_24
	const EVENT_BEAT_MT_BATTLE_25 ; 1f8
	const EVENT_BEAT_MT_BATTLE_26
	const EVENT_BEAT_MT_BATTLE_27
	const EVENT_BEAT_MT_BATTLE_28
	const EVENT_BEAT_MT_BATTLE_29
	const EVENT_BEAT_MT_BATTLE_30
	const EVENT_BEAT_MT_BATTLE_31
	const EVENT_BEAT_MT_BATTLE_32
	const EVENT_BEAT_MT_BATTLE_33 ; 200
	const EVENT_BEAT_MT_BATTLE_34
	const EVENT_BEAT_MT_BATTLE_35
	const EVENT_BEAT_MT_BATTLE_36
	const EVENT_BEAT_MT_BATTLE_37
	const EVENT_BEAT_MT_BATTLE_38
	const EVENT_BEAT_MT_BATTLE_39
	const EVENT_BEAT_MT_BATTLE_40
	const EVENT_BEAT_MT_BATTLE_41 ; 208
	const EVENT_BEAT_MT_BATTLE_42
	const EVENT_BEAT_MT_BATTLE_43
	const EVENT_BEAT_MT_BATTLE_44
	const EVENT_BEAT_MT_BATTLE_45
	const EVENT_BEAT_MT_BATTLE_46
	const EVENT_BEAT_MT_BATTLE_47
	const EVENT_BEAT_MT_BATTLE_48
	const EVENT_BEAT_MT_BATTLE_49 ; 210
	const EVENT_BEAT_MT_BATTLE_50
	const EVENT_BEAT_MT_BATTLE_51
	const EVENT_BEAT_MT_BATTLE_52
	const EVENT_BEAT_MT_BATTLE_53
	const EVENT_BEAT_MT_BATTLE_54
	const EVENT_BEAT_MT_BATTLE_55
	const EVENT_BEAT_MT_BATTLE_56
	const EVENT_BEAT_MT_BATTLE_57 ; 218
	const EVENT_BEAT_MT_BATTLE_58
	const EVENT_BEAT_MT_BATTLE_59
	const EVENT_BEAT_MT_BATTLE_60
	const EVENT_BEAT_MT_BATTLE_61
	const EVENT_BEAT_MT_BATTLE_62
	const EVENT_BEAT_MT_BATTLE_63
	const EVENT_BEAT_MT_BATTLE_64
	const EVENT_BEAT_MT_BATTLE_65 ; 220
	const EVENT_BEAT_MT_BATTLE_66
	const EVENT_BEAT_MT_BATTLE_67
	const EVENT_BEAT_MT_BATTLE_68
	const EVENT_BEAT_MT_BATTLE_69
	const EVENT_BEAT_MT_BATTLE_70
	const EVENT_BEAT_MT_BATTLE_71
	const EVENT_BEAT_MT_BATTLE_72
	const EVENT_BEAT_MT_BATTLE_73 ; 228
	const EVENT_BEAT_MT_BATTLE_74
	const EVENT_BEAT_MT_BATTLE_75
	const EVENT_BEAT_MT_BATTLE_76
	const EVENT_BEAT_MT_BATTLE_77
	const EVENT_BEAT_MT_BATTLE_78
	const EVENT_BEAT_MT_BATTLE_79
	const EVENT_BEAT_MT_BATTLE_80
	const EVENT_BEAT_MT_BATTLE_81 ; 230
	const EVENT_BEAT_MT_BATTLE_82
	const EVENT_BEAT_MT_BATTLE_83
	const EVENT_BEAT_MT_BATTLE_84
	const EVENT_BEAT_MT_BATTLE_85
	const EVENT_BEAT_MT_BATTLE_86
	const EVENT_BEAT_MT_BATTLE_87
	const EVENT_BEAT_MT_BATTLE_88
	const EVENT_BEAT_MT_BATTLE_89 ; 238
	const EVENT_BEAT_MT_BATTLE_90
	const EVENT_BEAT_MT_BATTLE_91
	const EVENT_BEAT_MT_BATTLE_92
	const EVENT_BEAT_MT_BATTLE_93
	const EVENT_BEAT_MT_BATTLE_94
	const EVENT_BEAT_MT_BATTLE_95
	const EVENT_BEAT_MT_BATTLE_96
	const EVENT_BEAT_MT_BATTLE_97 ; 240
	const EVENT_BEAT_MT_BATTLE_98
	const EVENT_BEAT_MT_BATTLE_99
	const EVENT_BEAT_MT_BATTLE_100
	const EVENT_MT_BATTLE_HEALED_2F
	const EVENT_MT_BATTLE_HEALED_3F
	const EVENT_MT_BATTLE_HEALED_4F
	const EVENT_MT_BATTLE_HEALED_5F
	const EVENT_MT_BATTLE_HEALED_6F ; 248
	const EVENT_MT_BATTLE_HEALED_7F
	const EVENT_MT_BATTLE_HEALED_8F
	const EVENT_MT_BATTLE_HEALED_9F
	const EVENT_MT_BATTLE_HEALED_10F
	const EVENT_MT_BATTLE_HEALED_11F
	const EVENT_MT_BATTLE_TALKED_WITH_FINAL_TRAINER
	const EVENT_BEAT_SS
	...
	const EVENT_UNLOCKED_ALL_UNOWN_RESEARCHER_FILES
	const EVENT_BEAT_ELITE_FOUR_REMATCH
	const EVENT_CLEARED_MT_BATTLE_AT_LEAST_ONCE
	...
	const EVENT_GOT_IRON_FROM_PARRY ; 268
	...
	const EVENT_DECO_SURFING_PIKACHU_DOLL ; 2b8
	...
	const EVENT_DECO_UNOWN_DOLL ; 2c8
	...
	const EVENT_SECURITY_CAMERA_5 ; 2e8
	...
	const EVENT_EXPLODING_TRAP_16 ; 2f8
	...
	const EVENT_LEFT_MONS_WITH_CONTEST_OFFICER ; 308
	...
	const EVENT_WILTON_HAS_GREAT_BALL ; 330
	...
	const EVENT_BEAT_MT_SILVER
	const EVENT_GOT_SILVER_WING_FROM_POKECOM_CENTER ; 340
	const skip
	const skip
	const skip
	const skip
	...
	const EVENT_BEAT_SWIMMERF_JILL ; 3f0
	...
	const EVENT_BEAT_SWIMMERF_NIKKI ; 3f8
	...
	const EVENT_BEAT_BIRD_KEEPER_DENIS ; 400
	...
	const EVENT_BEAT_BIRD_KEEPER_JOSE2 ; 408
	...
	const EVENT_BEAT_BOARDER_DOUGLAS ; 410
	...
	const EVENT_BEAT_SAGE_NEAL ; 418
	...
	const EVENT_BEAT_CAMPER_DEAN ; 420
	...
	const EVENT_BEAT_CAMPER_LEROY ; 428
	...
	const EVENT_BEAT_BIKER_JOEL ; 438
	...
	const EVENT_BEAT_PSYCHIC_MARK ; 440
	...
	const EVENT_BEAT_FIREBREATHER_NED ; 448
	...
	const EVENT_BEAT_FISHER_ARNOLD ; 450
	...
	const EVENT_BEAT_FISHER_EDGAR ; 458
	...
	const EVENT_BEAT_FISHER_TULLY3 ; 460
	...
	const EVENT_BEAT_TWINS_JO_AND_ZOE ; 468
	...
	const EVENT_BEAT_SCHOOLBOY_DANNY ; 470
	...
	const EVENT_BEAT_SCHOOLBOY_JACK2 ; 478
	...
	const EVENT_BEAT_PICNICKER_BROOKE ; 480
	...
	const EVENT_BEAT_PICNICKER_LIZ2 ; 488
	...
	const EVENT_BEAT_PICNICKER_TANYA ; 490
	...
	const EVENT_BEAT_JUGGLER_IRWIN2 ; 498
	...
	const EVENT_BEAT_SCIENTIST_MITCH ; 4a0
	...
	const EVENT_BEAT_BLACKBELT_NOB ; 4a8
	...
	const EVENT_BEAT_BEAUTY_JACLYN ; 4b0
	...
	const EVENT_BEAT_BEAUTY_KENDRA ; 4b8
	...
	const EVENT_BEAT_POKEFANM_JOSHUA ; 4d0
	...
	const EVENT_BEAT_POKEFANM_ALEX ; 4d8
	...
	const EVENT_BEAT_KIMONO_GIRL_REA
	const EVENT_BEAT_KIMONO_GIRL_NAOKO
	const EVENT_BEAT_KIMONO_GIRL_SAYO ; 4e0
	...
	const EVENT_BEAT_POKEMANIAC_BEN ; 4e8
	...
	const EVENT_BEAT_POKEMANIAC_ZACH ; 4f0
	...
	const EVENT_BEAT_ROCKET_GRUNTM_8 ; 4f8
	...
	const EVENT_BEAT_ROCKET_GRUNTM_16 ; 500
	...
	const EVENT_BEAT_ROCKET_GRUNTM_24 ; 508
	...
	const EVENT_BEAT_ROCKET_GRUNTF_1 ; 510
	...
	const EVENT_BEAT_LASS_KRISE ; 518
	...
	const EVENT_BEAT_LASS_CONNIE2 ; 520
	...
	const EVENT_BEAT_HIKER_ANTHONY ; 528
	...
	const EVENT_BEAT_HIKER_TIM ; 530
	...
	const EVENT_BEAT_BUG_CATCHER_DON ; 538
	...
	const EVENT_BEAT_BUG_CATCHER_KEN ; 540
	...
	const EVENT_BEAT_COOLTRAINERM_NICK ; 548
	...
	const EVENT_BEAT_COOLTRAINERM_JAKE ; 550
	...
	const EVENT_BEAT_COOLTRAINERM_KEVIN ; 558
	...
	const EVENT_BEAT_COOLTRAINERF_IRENE ; 560
	...
	const EVENT_BEAT_COOLTRAINERF_QUINN ; 568
	...
	const EVENT_BEAT_ROCKET_EXECUTIVEF_2 ; 570
	...
	const EVENT_BEAT_SAILOR_KENT ; 578
	...
	const EVENT_BEAT_SAILOR_HUEY3 ; 580
	...
	const EVENT_BEAT_SUPER_NERD_PAT ; 588
	...
	const EVENT_BEAT_MEDIUM_REBECCA ; 590
	...
	const EVENT_BEAT_SWIMMERM_GEORGE ; 598
	...
	const EVENT_BEAT_SWIMMERM_TONY ; 5a0
	...
	const EVENT_BEAT_SWIMMERM_PARKER ; 5a8
	...
	const EVENT_BEAT_YOUNGSTER_JOEY3 ; 5b0
	...
	const EVENT_BEAT_ELITE_4_WILL ; 5b8
	...
	const EVENT_BEAT_BUG_CATCHER_WAYNE ; 5c0
	...
	const EVENT_BEAT_POKEFANM_ALLAN ; 5c8
	const EVENT_BEAT_SAGE_GAKU
	const EVENT_BEAT_SAGE_MASA
	const EVENT_BEAT_SAGE_KOJI
	const EVENT_BEAT_KIMONO_GIRL_LINNEA
	const EVENT_BEAT_KIMONO_GIRL_SAKUYA
	const EVENT_BEAT_GUITARIST_JAMIE
	const EVENT_BEAT_BUG_CATCHER_DANE
	const EVENT_BEAT_BUG_CATCHER_DION ; 5d0
	...
	const EVENT_BEAT_MEDIUM_CARLY
	const EVENT_BEAT_SAGE_YIN ; 5d8
	...
	const skip
	const skip
	const EVENT_BABA_IN_ELMS_LAB ; 640
	const EVENT_EVAN_IN_ELMS_LAB
	const EVENT_AJ_IN_ELMS_LAB
	...
	const EVENT_SPROUT_TOWER2F_X_ACCURACY ; 648
	...
	const EVENT_NATIONAL_PARK_PARLYZ_HEAL ; 658
	...
	const EVENT_UNION_CAVE_B2F_ELIXIR ; 660
	...
	const EVENT_OLIVINE_LIGHTHOUSE_6F_SUPER_POTION ; 668
	...
	const EVENT_GOLDENROD_DEPT_STORE_B1F_ULTRA_BALL ; 678
	...
	const EVENT_MOUNT_MORTAR_1F_INSIDE_MOON_STONE
	...
	const EVENT_GOT_TM09_PSYCH_UP ; 688
	...
	const EVENT_WHIRL_ISLAND_SW_ULTRA_BALL ; 690
	...
	const EVENT_WHIRL_ISLAND_B2F_MAX_ELIXIR ; 698
	...
	const EVENT_DRAGONS_DEN_B1F_DRAGON_FANG ; 6a8
	...
	const EVENT_ROUTE_45_NUGGET ; 6b8
	...
	const EVENT_DAY_CARE_MON_2 ; 6e8
	...
	const EVENT_GOLDENROD_SALE_OFF ; 6f0
	const EVENT_GOLDENROD_SALE_ON
	const EVENT_DARKRAI_IN_POKEMON_TOWER
	...
	const EVENT_ROUTE_36_SUDOWOODO ; 6f8
	...
	const EVENT_BOULDER_IN_BLACKTHORN_GYM_3 ; 708
	...
	const EVENT_BUG_CATCHING_CONTESTANT_3A ; 718
	...
	const EVENT_BUG_CATCHING_CONTESTANT_9B ; 728
	...
	const EVENT_OLIVINE_PORT_SPRITES_BEFORE_CLAIR
	const EVENT_OLIVINE_PORT_SPRITES_AFTER_CLAIR ; 738
	...
	const EVENT_ROUTE_36_NATIONAL_PARK_GATE_OFFICER_NOT_CONTEST_DAY ; 748
	...
	const EVENT_OAK_MENTIONED_MT_SILVER
	...
	const EVENT_ROUTE_32_FRIEDA_OF_FRIDAY ; 758
	...
	const EVENT_ROUTE_12_CALCIUM ; 788
	...
	const EVENT_PICKED_UP_BERRY_FROM_KABUTO_ITEM_ROOM ; 798
	...
	const EVENT_POKEMON_LEAGUE_NO_REMATCH
	...
	const EVENT_ROUTE_30_ANTIDOTE ; 7b8
	...
	const EVENT_DRAGONS_DEN_B1F_MAX_ELIXIR ; 7c0
	...
	const EVENT_MOUNT_MORTAR_1F_INSIDE_IRON ; 7c8
