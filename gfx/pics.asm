...
RedLarryPic:         INCBIN "gfx/trainers/red-snow.2bpp.lz"
...
JumpaniumFrontpic:   INCBIN "gfx/pokemon/jumpanium/front.animated.2bpp.lz"
JumpaniumBackpic:    INCBIN "gfx/pokemon/jumpanium/back.2bpp.lz"
MegastoiseFrontpic:  INCBIN "gfx/pokemon/megastoise/front.animated.2bpp.lz"
MegastoiseBackpic:   INCBIN "gfx/pokemon/megastoise/back.2bpp.lz"
NoctdrioFrontpic:    INCBIN "gfx/pokemon/noctdrio/front.animated.2bpp.lz"
NoctdrioBackpic:     INCBIN "gfx/pokemon/noctdrio/back.2bpp.lz"
...
BurmySandyBackpic::  INCBIN "gfx/pokemon/burmy-sandy/back.2bpp.lz"
BurmyTrashBackpic::  INCBIN "gfx/pokemon/burmy-trash/back.2bpp.lz"
...
ChiquirtleBackpic:   INCBIN "gfx/pokemon/chiquirtle/back.2bpp.lz"
HootduoFrontpic:     INCBIN "gfx/pokemon/hootduo/front.animated.2bpp.lz"
HopporitaFrontpic:   INCBIN "gfx/pokemon/hopporita/front.animated.2bpp.lz"
HopporitaBackpic:    INCBIN "gfx/pokemon/hopporita/back.2bpp.lz"
OnixtretFrontpic:    INCBIN "gfx/pokemon/onixtret/front.animated.2bpp.lz"
OnixtretBackpic:     INCBIN "gfx/pokemon/onixtret/back.2bpp.lz"
...
BattlePCPic:         INCBIN "gfx/trainers/battle-pc.2bpp.lz"
...
BurmySandyFrontpic:: INCBIN "gfx/pokemon/burmy-sandy/front.animated.2bpp.lz"
BurmyTrashFrontpic:: INCBIN "gfx/pokemon/burmy-trash/front.animated.2bpp.lz"
...
HootduoBackpic:      INCBIN "gfx/pokemon/hootduo/back.2bpp.lz"
