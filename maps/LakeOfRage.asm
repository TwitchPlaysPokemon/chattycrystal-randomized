...
LakeOfRage_MapEvents:
	...
	db 12 ; object events
	object_event 21, 28, SPRITE_CYAN, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, LakeOfRageLanceScript, EVENT_INITIALIZED_EVENTS
	...
	object_event  7, 10, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, LakeOfRageElixir, EVENT_LAKE_OF_RAGE_ELIXIR
