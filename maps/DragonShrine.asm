...
.PassedTheTest:
	...
	writetext DragonShrineGiveTicket2
	waitbutton
	closetext
...
DragonShrine_MapEvents:
	...
	object_event  4,  8, SPRITE_NATE, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_INITIALIZED_EVENTS
