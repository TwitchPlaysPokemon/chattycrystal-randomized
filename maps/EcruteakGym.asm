...
EcruteakGymStatue:
	...
	jumpstd gymstatue1
.Beaten:
	gettrainername STRING_BUFFER_4, HGSS_LYRA, AOOOO
	jumpstd gymstatue2
...
EcruteakGym_MapEvents:
	...
	db 7 ; object events
	object_event  5,  1, SPRITE_LYRA, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, EcruteakGymMortyScript, -1
