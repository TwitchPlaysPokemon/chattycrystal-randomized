...
EcruteakCity_MapEvents:
	...
	warp_event  5, 17, ECRUTEAK_SHADOW_CLAW_TUTOR_HOUSE, 1
	...
	object_event  3,  9, SPRITE_LASS, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, EcruteakCityLass2Script, -1
