...
BattleTowerMons1:
	...
	dw SNEASEL
	db GOLD_BERRY
	dw SLASH, FEINT_ATTACK, SURF, BLIZZARD
	...
	dw HOUNDOUR
	db GOLD_BERRY
	dw FEINT_ATTACK, SOLARBEAM, ROAR, SUNNY_DAY
...
BattleTowerMons6:
	...
	dw UMBREON
	db GOLD_BERRY
	dw MUD_SLAP, MOONLIGHT, PSYCHIC_M, FEINT_ATTACK
...
BattleTowerMons7:
	...
	dw UMBREON
	db GOLD_BERRY
	dw FEINT_ATTACK, MOONLIGHT, PSYCH_UP, TOXIC
	...
	dw HOUNDOOM
	db KINGS_ROCK
	dw CRUNCH, FLAMETHROWER, FEINT_ATTACK, ROAR
	...
	dw UMBREON
	db GOLD_BERRY
	dw MOONLIGHT, FEINT_ATTACK, PSYCHIC_M, SHADOW_BALL
...
BattleTowerMons9:
	...
	dw UMBREON
	db KINGS_ROCK
	dw FEINT_ATTACK, MUD_SLAP, MOONLIGHT, CONFUSE_RAY
...
BattleTowerMons10:
	...
	dw WALREIN
	db ULTRA_BALL
	dw BLIZZARD, FISSURE, RAIN_DANCE, WATER_GUN
	...
	dw GARDEVOIR
	db TWISTEDSPOON
	dw DAZZLINGLEAM, PSYCHIC_M, THUNDERBOLT, FOCUS_BLAST
	...
	dw QUAGSIRE
	db HARD_STONE
	dw AMNESIA, DARK_VOID, EARTHQUAKE, RAIN_DANCE
