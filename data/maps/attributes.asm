	...
	map_attributes GoldenrodMoveRelearner, GOLDENROD_MOVE_RELEARNER, $00, 0
	...
	map_attributes SeafloorCavernRoom1, SEAFLOOR_CAVERN_ROOM_1, $09, 0
	map_attributes SeafloorCavernRoom4, SEAFLOOR_CAVERN_ROOM_4, $09, 0
	...
	map_attributes BattleTentRuins, BATTLE_TENT_RUINS, $00, 0
	map_attributes BattleTentBattleRoom, BATTLE_TENT_BATTLE_ROOM, $00, 0
	map_attributes BattleTentGenerator, BATTLE_TENT_GENERATOR, $00, 0
	map_attributes BattleTentPCRoom, BATTLE_TENT_PC_ROOM, $00, 0
	...
	map_attributes SilphCoRoof, SILPH_CO_ROOF, $24, 0
