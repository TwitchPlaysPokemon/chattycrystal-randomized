...
;\3: environment: TOWN, ROUTE, INDOOR, CAVE, ISOLATED, GATE, or DUNGEON
...
MapGroup_Dungeons:
	...
	map RuinsOfAlphHoOhChamber, TILESET_HO_OH_WORD_ROOM, DUNGEON, RUINS_OF_ALPH, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RuinsOfAlphKabutoChamber, TILESET_HO_OH_WORD_ROOM, DUNGEON, RUINS_OF_ALPH, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RuinsOfAlphOmanyteChamber, TILESET_HO_OH_WORD_ROOM, DUNGEON, RUINS_OF_ALPH, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RuinsOfAlphAerodactylChamber, TILESET_HO_OH_WORD_ROOM, DUNGEON, RUINS_OF_ALPH, MUSIC_UNION_CAVE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map SilverCaveRoom1, TILESET_DARK_CAVE, CAVE, SILVER_CAVE, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map SilverCaveRoom2, TILESET_CAVE, CAVE, SILVER_CAVE, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map SilverCaveRoom3, TILESET_SILVER_CAVE, ISOLATED, SILVER_CAVE, MUSIC_LIGHTHOUSE, TRUE, PALETTE_AUTO, FISHGROUP_LAKE
	...
	map ViridianForest, TILESET_KANTO_FOREST, ROUTE, VIRIDIAN_FOREST, MUSIC_DIGLETTS_CAVE, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map CeruleanCave1F, TILESET_CAVE, CAVE, CERULEAN_CAVE, MUSIC_CERULEAN_CAVE, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
	map CeruleanCave2F, TILESET_CAVE, CAVE, CERULEAN_CAVE, MUSIC_CERULEAN_CAVE, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
	map CeruleanCaveB1F, TILESET_CAVE, CAVE, CERULEAN_CAVE, MUSIC_CERULEAN_CAVE, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
	map PokemonMansion1F, TILESET_PKMN_MANSION, DUNGEON, POKEMON_MANSION, MUSIC_POKEMON_MANSION, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map PokemonMansion2F, TILESET_PKMN_MANSION, DUNGEON, POKEMON_MANSION, MUSIC_POKEMON_MANSION, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map PokemonMansion3F, TILESET_PKMN_MANSION, DUNGEON, POKEMON_MANSION, MUSIC_POKEMON_MANSION, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map PokemonMansionB1F, TILESET_PKMN_MANSION, DUNGEON, POKEMON_MANSION, MUSIC_POKEMON_MANSION, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map RocketHideoutB1F, TILESET_PKMN_MANSION, DUNGEON, CELADON_CITY, MUSIC_CERULEAN_CAVE, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map RocketHideoutB2F, TILESET_PKMN_MANSION, DUNGEON, CELADON_CITY, MUSIC_CERULEAN_CAVE, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map RocketHideoutB3F, TILESET_PKMN_MANSION, DUNGEON, CELADON_CITY, MUSIC_CERULEAN_CAVE, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map RocketHideoutB4F, TILESET_PKMN_MANSION, DUNGEON, CELADON_CITY, MUSIC_CERULEAN_CAVE, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map RocketHideoutElevator, TILESET_PKMN_MANSION, DUNGEON, CELADON_CITY, MUSIC_CERULEAN_CAVE, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map PokemonTower1F, TILESET_CEMETERY, DUNGEON, LAVENDER_TOWN, MUSIC_POKEMON_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonTower2F, TILESET_CEMETERY, DUNGEON, LAVENDER_TOWN, MUSIC_POKEMON_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonTower3F, TILESET_CEMETERY, DUNGEON, LAVENDER_TOWN, MUSIC_POKEMON_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonTower4F, TILESET_CEMETERY, DUNGEON, LAVENDER_TOWN, MUSIC_POKEMON_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonTower5F, TILESET_CEMETERY, DUNGEON, LAVENDER_TOWN, MUSIC_POKEMON_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonTower6F, TILESET_CEMETERY, DUNGEON, LAVENDER_TOWN, MUSIC_POKEMON_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonTower7F, TILESET_CEMETERY, DUNGEON, LAVENDER_TOWN, MUSIC_POKEMON_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MtSilverRuins, TILESET_RUINS_OF_ALPH, DUNGEON, SILVER_CAVE, MUSIC_DRAGONS_DEN, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map MtSilverRuinsB1F, TILESET_CAVE, CAVE, SILVER_CAVE, MUSIC_DRAGONS_DEN, TRUE, PALETTE_NITE, FISHGROUP_NONE
...
MapGroup_Ecruteak:
	...
	map EcruteakShadowClawTutorHouse, TILESET_TRADITIONAL_HOUSE, INDOOR, ECRUTEAK_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cinnabar:
	...
	map SeafoamIslands1F, TILESET_CAVE, CAVE, SEAFOAM_ISLANDS, MUSIC_DIGLETTS_CAVE, TRUE, PALETTE_DAY, FISHGROUP_DRATINI
	map SeafoamIslandsB1F, TILESET_ICE_PATH, CAVE, SEAFOAM_ISLANDS, MUSIC_DIGLETTS_CAVE, TRUE, PALETTE_DAY, FISHGROUP_DRATINI
	map SeafoamIslandsB2F, TILESET_ICE_PATH, CAVE, SEAFOAM_ISLANDS, MUSIC_DIGLETTS_CAVE, TRUE, PALETTE_DAY, FISHGROUP_DRATINI
	map SeafoamIslandsB3F, TILESET_ICE_PATH, CAVE, SEAFOAM_ISLANDS, MUSIC_DIGLETTS_CAVE, TRUE, PALETTE_DAY, FISHGROUP_DRATINI
	map SeafoamIslandsB4F, TILESET_ICE_PATH, CAVE, SEAFOAM_ISLANDS, MUSIC_DIGLETTS_CAVE, TRUE, PALETTE_DAY, FISHGROUP_DRATINI
	map SeafoamGym, TILESET_CAVE, INDOOR, SEAFOAM_ISLANDS, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_DRATINI
...
MapGroup_Cerulean:
	map CeruleanGymBadgeSpeechHouse, TILESET_HOUSE, INDOOR, CERULEAN_CITY, MUSIC_CERULEAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanPoliceStation, TILESET_HOUSE, INDOOR, CERULEAN_CITY, MUSIC_CERULEAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanTradeSpeechHouse, TILESET_HOUSE, INDOOR, CERULEAN_CITY, MUSIC_CERULEAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CeruleanMart, TILESET_MART, INDOOR, CERULEAN_CITY, MUSIC_CERULEAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map PowerPlant, TILESET_FACILITY, INDOOR, POWER_PLANT, MUSIC_CERULEAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PowerPlantB1F, TILESET_PKMN_MANSION, DUNGEON, POWER_PLANT, MUSIC_POKEMON_MANSION, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map BillsHouse, TILESET_HOUSE, INDOOR, ROUTE_25, MUSIC_CERULEAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route24, TILESET_KANTO, ROUTE, ROUTE_24, MUSIC_NUGGET_BRIDGE, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map Route25, TILESET_KANTO, ROUTE, ROUTE_25, MUSIC_NUGGET_BRIDGE, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map CeruleanCity, TILESET_KANTO, TOWN, CERULEAN_CITY, MUSIC_CERULEAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_NONE
...
MapGroup_Goldenrod:
	...
	map GoldenrodPokecenter1F, TILESET_POKECENTER, INDOOR, GOLDENROD_CITY, MUSIC_MOBILE_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map GoldenrodMoveRelearner, TILESET_HOUSE, INDOOR, GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Vermilion:
	...
	map KantoRadioTower1F, TILESET_RADIO_TOWER, INDOOR, KANTO_RADIO_TOWER, MUSIC_VERMILION_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Pallet:
	...
	map RedsHouse2F, TILESET_PLAYERS_HOUSE, INDOOR, PALLET_TOWN, MUSIC_PALLET_TOWN, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	...
	map SeafloorCavernEntrance, TILESET_CAVE, CAVE, SEAFLOOR_CAVERN, MUSIC_CAVE_OF_ORIGIN, TRUE, PALETTE_NITE, FISHGROUP_OCEAN
	map SeafloorCavernRoom1, TILESET_CAVE, CAVE, SEAFLOOR_CAVERN, MUSIC_CAVE_OF_ORIGIN, TRUE, PALETTE_NITE, FISHGROUP_OCEAN
	map SeafloorCavernRoom4, TILESET_CAVE, CAVE, SEAFLOOR_CAVERN, MUSIC_CAVE_OF_ORIGIN, TRUE, PALETTE_NITE, FISHGROUP_OCEAN
	map SeafloorCavernRoom5, TILESET_CAVE, CAVE, SEAFLOOR_CAVERN, MUSIC_CAVE_OF_ORIGIN, TRUE, PALETTE_NITE, FISHGROUP_OCEAN
	map SeafloorCavernRoom8, TILESET_CAVE, CAVE, SEAFLOOR_CAVERN, MUSIC_CAVE_OF_ORIGIN, TRUE, PALETTE_NITE, FISHGROUP_OCEAN
	map SeafloorCavernRoom9, TILESET_CAVE, CAVE, SEAFLOOR_CAVERN, MUSIC_CAVE_OF_ORIGIN, TRUE, PALETTE_NITE, FISHGROUP_OCEAN
	map SeafloorCavernCopycat, TILESET_CAVE, CAVE, SEAFLOOR_CAVERN, MUSIC_CAVE_OF_ORIGIN, TRUE, PALETTE_NITE, FISHGROUP_OCEAN
...
MapGroup_Indigo:
	map Route23, TILESET_KANTO, TOWN, ROUTE_23, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_POND
	...
	map KarensRoom, TILESET_ELITE_FOUR_ROOM, INDOOR, INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	...
	map IndigoPlateauOutside, TILESET_KANTO, ROUTE, INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup_Fuchsia:
	...
	map FuchsiaCity, TILESET_KANTO, TOWN, FUCHSIA_CITY, MUSIC_CERULEAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_GYARADOS
	map FuchsiaMart, TILESET_MART, INDOOR, FUCHSIA_CITY, MUSIC_CERULEAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneMainOffice, TILESET_GAME_CORNER, INDOOR, FUCHSIA_CITY, MUSIC_CERULEAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FuchsiaGym, TILESET_LAB, INDOOR, FUCHSIA_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map BillsBrothersHouse, TILESET_HOUSE, INDOOR, FUCHSIA_CITY, MUSIC_CERULEAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FuchsiaPokecenter1F, TILESET_POKECENTER, INDOOR, FUCHSIA_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FuchsiaPokecenter2FBeta, TILESET_POKECENTER, INDOOR, FUCHSIA_CITY, MUSIC_CERULEAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneWardensHome, TILESET_HOUSE, INDOOR, FUCHSIA_CITY, MUSIC_CERULEAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route15FuchsiaGate, TILESET_GATE, GATE, ROUTE_15, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneFuchsiaGate, TILESET_GATE, INDOOR, FUCHSIA_CITY, MUSIC_CERULEAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Celadon:
	...
	map BattleTentRuins, TILESET_BATTLE_TOWER, DUNGEON, CELADON_CITY, MUSIC_BATTLE_TENT_RUINS, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map BattleTentBattleRoom, TILESET_BATTLE_TOWER, DUNGEON, CELADON_CITY, MUSIC_BATTLE_TENT_RUINS, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map BattleTentGenerator, TILESET_FACILITY, DUNGEON, CELADON_CITY, MUSIC_BATTLE_TENT_RUINS, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map BattleTentPCRoom, TILESET_BATTLE_TOWER, DUNGEON, CELADON_CITY, MUSIC_BATTLE_TENT_RUINS, FALSE, PALETTE_NITE, FISHGROUP_NONE
...
MapGroup_Viridian:
	...
	map ViridianForestNorthGate, TILESET_GATE, GATE, ROUTE_2, MUSIC_ROUTE_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianForestSouthGate, TILESET_GATE, GATE, ROUTE_2, MUSIC_ROUTE_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TrickHouseEntrance, TILESET_TRADITIONAL_HOUSE, INDOOR, VIRIDIAN_CITY, MUSIC_TRICK_HOUSE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TrickHouseExit, TILESET_TRADITIONAL_HOUSE, INDOOR, VIRIDIAN_CITY, MUSIC_TRICK_HOUSE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TrickHouseHallway, TILESET_TRADITIONAL_HOUSE, INDOOR, VIRIDIAN_CITY, MUSIC_TRICK_HOUSE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TrickHousePuzzle1, TILESET_TRADITIONAL_HOUSE, INDOOR, VIRIDIAN_CITY, MUSIC_TRICK_HOUSE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TrickHousePuzzle2, TILESET_TRADITIONAL_HOUSE, INDOOR, VIRIDIAN_CITY, MUSIC_TRICK_HOUSE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TrickHousePuzzle3, TILESET_TRADITIONAL_HOUSE, INDOOR, VIRIDIAN_CITY, MUSIC_TRICK_HOUSE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TrickHousePuzzle4, TILESET_TRADITIONAL_HOUSE, INDOOR, VIRIDIAN_CITY, MUSIC_TRICK_HOUSE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TrickHousePuzzle5, TILESET_TRADITIONAL_HOUSE, INDOOR, VIRIDIAN_CITY, MUSIC_TRICK_HOUSE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TrickHousePuzzle6, TILESET_TRADITIONAL_HOUSE, INDOOR, VIRIDIAN_CITY, MUSIC_TRICK_HOUSE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianMoveTutorHouse, TILESET_HOUSE, INDOOR, VIRIDIAN_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Saffron:
	...
	map SilphCo2F, TILESET_FACILITY, INDOOR, SAFFRON_CITY, MUSIC_SILPH_CO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCo3F, TILESET_FACILITY, INDOOR, SAFFRON_CITY, MUSIC_SILPH_CO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCo4F, TILESET_FACILITY, INDOOR, SAFFRON_CITY, MUSIC_SILPH_CO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCo5F, TILESET_RADIO_TOWER, INDOOR, SAFFRON_CITY, MUSIC_SILPH_CO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCo6F, TILESET_RADIO_TOWER, INDOOR, SAFFRON_CITY, MUSIC_SILPH_CO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCo7F, TILESET_FACILITY, INDOOR, SAFFRON_CITY, MUSIC_SILPH_CO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCo8F, TILESET_FACILITY, INDOOR, SAFFRON_CITY, MUSIC_SILPH_CO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCo9F, TILESET_FACILITY, INDOOR, SAFFRON_CITY, MUSIC_SILPH_CO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCo10F, TILESET_RADIO_TOWER, INDOOR, SAFFRON_CITY, MUSIC_SILPH_CO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCo11F, TILESET_MUSEUM, INDOOR, SAFFRON_CITY, MUSIC_SILPH_CO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCoRoof, TILESET_MART, INDOOR, SAFFRON_CITY, MUSIC_SILPH_CO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCoElevator, TILESET_MART, INDOOR, SAFFRON_CITY, MUSIC_SILPH_CO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_SafariZone:
	map SafariZoneCenter, TILESET_SAFARI, ROUTE, SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SafariZoneEast, TILESET_SAFARI, ROUTE, SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SafariZoneNorth, TILESET_SAFARI, ROUTE, SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SafariZoneWest, TILESET_SAFARI, ROUTE, SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
